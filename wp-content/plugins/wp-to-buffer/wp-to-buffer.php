...
class WP_To_Buffer {
    ...
    public function __construct() {
        ...
        $this->plugin->version          = '3.3.3';
        $this->plugin->buildDate        = '2018-01-29 12:00:00';
        ...
        $this->plugin->upgrade_reasons = array(
            array(
                __( 'Pinterest and Instagram Support', $this->plugin->name ), 
                __( 'Post to your Pinterest boards, and receive Instagram notifications to post to Instagram on your mobile device', $this->plugin->name ),
            ),
            array(
            ...
            array(
                ...
                __( 'Publish existing multiple Posts, Pages and Custom Post Types to Buffer', $this->plugin->name ),
            ),
            array(
...
register_activation_hook( __FILE__, array( 'WP_To_Buffer_Pro_Install', 'activate' ) );
add_action( 'activate_wpmu_site', array( 'WP_To_Buffer_Pro_Install', 'activate_wpmu_site' ) );