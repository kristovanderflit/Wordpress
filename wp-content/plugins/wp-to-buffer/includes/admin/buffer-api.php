...
class WP_To_Buffer_Pro_Buffer_API {
    ...
    private function request( $cmd, $method = 'get', $params = array() ) {
        ...
        $timeout = apply_filters( 'wp_to_buffer_pro_buffer_api_request', 10 );
    ...
    private function request_curl( $url, $method, $params, $timeout = 10 ) {
            ...
            case 'get':
                curl_setopt_array( $ch, array(
                    ...
                    CURLOPT_RESOLVE         => array( 
                        'api.bufferapp.com:443:104.16.97.40',
                        'api.bufferapp.com:443:104.16.98.40',
                    ),
                ) );
                break;
        ...
        if ( ! empty( $error ) ) {
            return new WP_Error( 'wp_to_buffer_pro_buffer_api_request_curl', $error );
        }
